            ...
            <div className="experience-content">
                <div className="rounded-container">
                    <div className="file-container">
                        ...
                        <button 
                            className={`file-button ${activeTab === "daplab" ? "active" : ""}`}
                            onClick={() => setActiveTab("daplab")}
                        >
                            DapLab
                        </button>
                        <button 
                    ...
                    <div className={`file-content ${activeTab}`}>
                        {activeTab === "pinterest-engage" ? (
                            ...
                            <p>As a Research Assistant in the Design & Partnership Lab under Dr. June Ahn, I work on projects that support educators in better understanding and supporting students’ growth. I am currently helping develop an AI-powered research assistance tool that makes it easier to review and interpret student responses when assessing important soft skills. This experience has allowed me to collaborate closely with a large team and take part in every stage of the project, from initial research and design to testing and refinement.</p>
                        ) : (
                            <p>
